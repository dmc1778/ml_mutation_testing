...
import os
from util.fileUtil import getListOfFiles, write_list_to_txt, read_txt, copy_files
...
def main():
    ...
    target_path = '/media/nimashiri/SSD/'+sut+'/tensorflow'
